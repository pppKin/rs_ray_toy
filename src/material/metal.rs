use crate::{
    ...
    reflection::{Bsdf, FresnelConductor, MicrofacetReflection},
...
impl Material for MetalMaterial {
    fn compute_scattering_functions(
        ...
        let fr_mf =
            FresnelConductor::new(Spectrum::one(), self.eta.evaluate(si), self.k.evaluate(si));
...
pub const COPPER_SAMPLES: usize = 56;
pub const COPPER_WAVELENGTHS: [f64; COPPER_SAMPLES] = [
    298.7570554,
    302.4004341,
    306.1337728,
    309.960445,
...
pub const COPPER_N_SAMPLES: [f64; COPPER_SAMPLES] = [
...
pub const COPPER_K_SAMPLES: [f64; COPPER_SAMPLES] = [
...
lazy_static! {
    pub static ref COPPER_N: Spectrum::<SPECTRUM_N> = Spectrum::<SPECTRUM_N>::from_sampled(
        &COPPER_WAVELENGTHS,
        &COPPER_N_SAMPLES,
        COPPER_SAMPLES
    );
    pub static ref COPPER_K: Spectrum::<SPECTRUM_N> = Spectrum::<SPECTRUM_N>::from_sampled(
        &COPPER_WAVELENGTHS,
        &COPPER_K_SAMPLES,
        COPPER_SAMPLES
    );
